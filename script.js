const App = () => {
  ...
  const themeVars = theme === 'dark' ? {
    app: { backgroundColor: '#1A1F2B' },
    terminal: { boxShadow: '0 2px 5px #111' },
    window: { backgroundColor: '#292e3b', color: '#FFFFFF' },
    field: { backgroundColor: '#292e3b', color: '#F4F4F4', fontWeight: 'normal' },
    cursor: { animation: '1.02s blink-dark step-end infinite' } } :
  {
    app: { backgroundColor: '#fffff3' },
    terminal: { boxShadow: '0 2px 5px #333333' },
    window: { backgroundColor: '#f5f5e9', color: '#333333' },
    field: { backgroundColor: '#f5f5e9', color: '#474554', fontWeight: 'bold' },
...
const Terminal = ({ theme, setTheme }) => {
  ...
  const [title, setTitle] = React.useState('Kiana Zaychik');
  const handleClose = () => window.location.href = 'https://github.com/veldanava';
  const handleMinMax = () => {
...
class Field extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      fieldHistory: [{ text: `
      H E L L O H A C K E R S !!! ||
      github: @veldanava
      ` }, { text: 'plz type HELP to start', hasBuffer: true }],
      userInput: '',
      isMobile: false };
    ...
    {
      command: 'exit',
      purpose: 'Quits the Terminaland returns to Kiana portfolio page.' },
    {
      command: 'time',
      purpose: 'Displays the current time.' },
    {
      command: 'about',
      isMain: true,
      purpose: 'Displays basic information about Kiana.' },
    {
      command: 'experience',
      isMain: true,
      purpose: 'Displays information about Kiana experience.' },
    {
      command: 'skills',
      isMain: true,
      purpose: 'Displays information about Kiana skills as a developer.' },
    {
      command: 'contact',
      isMain: true,
      purpose: 'Displays contact information for Kiana.' },
    {
      command: 'projects',
      isMain: true,
      purpose: 'Displays information about what projects Kiana has done in the past.' },
    {
      command: 'project',
      isMain: true,
      ...
      'List of Kiana TOP projects currently include:',
      'AiWaifu',
      'Guardian Tales char API',
      'TachikoGram',
      '',
...

    {
      ...
      '',
      'INPUT....................The title you want to use for the Terminalwindow.'] },
  ...
  componentDidMount() {
    if (typeof window.orientation !== "undefined" || navigator.userAgent.indexOf('IEMobile') !== -1) {
      ...
      document.querySelector('#useless-btn').addEventListener('click', () => this.setState(state => ({
        fieldHistory: [...state.fieldHistory, { isCommand: true }, { text: 'OwO >> That button doesn\'t do anything.', hasBuffer: true }] })));
  ...
  handleInputExecution(cmd, params = [], flags = []) {
    if (cmd === 'help') {
      ...
      () => window.open('https://github.com/veldanava'));
    } else if (cmd === 'theme') {
      ...
      return window.location.href = 'https://github.com/veldanava';
    } else if (cmd === 'time') {
      return this.setState(state => ({
      ...
      return this.setState(state => ({
        fieldHistory: [...state.fieldHistory, { text: [
          'Helloooo',
          `My name is Kiana and Im a Junior Fullstack Developer`,
          `Type CONTACT if you want to connect with me`,
          `>///<`],
          hasBuffer: true }] }));
      ...
      return this.setState(state => ({
        fieldHistory: [...state.fieldHistory, { text: [
          'Certificates:',
          'Fundamental Cybersecurity......................IBM',
          'Virtual Internship Back-End Developer.....Dicoding',
          'DevOps Engineer...........................Dicoding',
          'UI/UX Desginer.........................Competition',
          'Back-End Developer........................Dicoding',
          ],
          hasBuffer: true }] }));
      ...
      return this.setState(state => ({
        fieldHistory: [...state.fieldHistory, { text: [
          ...
          'Guardian Tales char API',
          'Built with Express',
          'Open API For Character On Guardian Tales',
          '',
          'TachikoGram',
          'Built with AdonisJS',
          `Social Media Like Instagram but Written On AdonisJS`],
          hasBuffer: true }] }));
      ...
      if (params.length === 1) {
        const projects = [{
          title: 'AiWaifu',
          live: 'https://github.com/veldanava/AiWaifu' },
        {
          title: 'Guardian Tales API',
          live: 'https://github.com/veldanava/Guardian-Tales-CharAPI' },
        {
          title: 'TachikoGram',
          live: 'https://github.com/veldanava/TACHIKOGRAM' }
        ];
      ...
      return this.setState(state => ({
        fieldHistory: [...state.fieldHistory, {
          text: `Set the Terminaltitle to ${params.length > 0 ? params.join(' ') : '<BLANK>'}`,
          hasBuffer: true }] }),
      ...
      if (cmd === "google") {
        return this.setState(state => ({
          fieldHistory: [...state.fieldHistory, {
            text: "Sorry, Google is your currently search engine",
            hasBuffer: true }] }));
...
isCommand && /*#__PURE__*/React.createElement("div", { id: "query" }, "kiana@localhost:"), /*#__PURE__*/
...
React.createElement("div", { id: "query" }, "kiana@localhost:"), /*#__PURE__*/
